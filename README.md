...
- [Generating sample-specifc containing FASTA databases with all combinations of variants](https://github.com/hdesai17/chemoproteogenomics#custom-database-generation-with-combinations-of-variants)
